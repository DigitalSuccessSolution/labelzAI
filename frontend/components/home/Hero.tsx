    ...
    <>
      ...
      <section className="bg-white border-b border-off-white-dark relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[300px] lg:h-[500px]">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center px-6 py-6 lg:py-10 lg:pl-6 lg:pr-8 xl:pl-8 xl:pr-10 bg-gradient-to-br from-[#dbeeff]/60 via-[#e8f4ff]/30 to-white text-navy relative z-10">
            ...
            <div className="max-w-xl relative z-10 pb-8 lg:pb-12">
              ...
              <p className="text-sm md:text-lg text-navy-gray leading-relaxed mb-8 font-inter">
